                ...
                <div class="mt-3">
                    ...
                    <ul class="list-group">
                        ...
                        <li class="list-group-item li-prof"><a href="{{route('edit.edit')}}">Changer vos informations
                                personnelles <img src="/img/user_black.svg"> </a></li>
                        <li class="list-group-item li-prof"><a href="{{route('blog.index')}}"> Choisir des articles à
                                mettre dans votre panier de favoris <img src="/img/star-filled.svg"></a></li>
                        ...
                        @if (Auth::user()->role == "Admin")
                            ...
                            <li class="list-group-item li-prof"><a href="{{route('blog.create')}}"> Créer de nouveaux
                                    articles <img src="/img/article_logo_black.svg"> </a></li>
                            <li class="list-group-item li-prof"><a href="{{route('blog.create')}}"> Updater un article
                                    déjà existant <img src="/img/article_logo_black.svg"> </a></li>
                        @endif
